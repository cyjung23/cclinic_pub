# **CC표준2: CC 작업이력·의사결정 (v4.0 / 2026-09-02)**

**기준일:** 2026-09-02
**이전 버전:** v3.0 (2026-05-12, 카카오톡 오픈채팅 상담채널 추가)
**변경 사유:** 결절제거주사 신규 페이지 구축(9번째 시술), 데스크탑 네비게이션 개편, 바디케어 드롭다운 메뉴 신설 (dev 브랜치 작업, main 미배포)  
...
### **2026-09-02: 결절제거주사 페이지 신규 구축 및 데스크탑 네비게이션 개편 (dev, main 미배포)**
...
모든 작업은 dev 브랜치에서 진행됐으며 아직 main 배포 전입니다. 상세 내역은 temp/작업로그_2026-09-02_결절제거.md 참조.
...
| 완료 | 결절제거주사 페이지 (데스크탑) | 2026-09-02 dev 완료, 모바일·배포 대기 |
| 보류 | 결절제거 모바일 페이지 및 main 배포 | 모바일 완성 후 sitemap 등록·main 병합 |
