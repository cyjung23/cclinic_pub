...
# **CC표준1: CC 마스터문서 (v6.0 / 2026-09-03)**

**기준일:** 2026-09-03  
 **이전 버전:** v5.0 (2026-05-12, 카카오톡 오픈채팅 상담채널 추가)  
 **변경 사유:** 결절제거주사(9번째 시술) 데스크탑·모바일·영문 구축 및 dev→main 라이브 배포, llms .md 생성·사이트맵 URL 25개, 시술 8종→9종 갱신, 영문 가격표(price_en.webp) 교체, 케이스 이미지 교체  
